...
import org.kafkaApp.Synopses.GKQuantiles.GKQuantiles;
import org.kafkaApp.Synopses.GKQuantiles.GKQuantilesDeserializer;
...
public class GKQuantilesSynopsisSerdes implements Serde<GKQuantilesSynopsis> {

    private final GKQuantilesSerializer gkQuantilesSerializer = new GKQuantilesSerializer();
    private final GKQuantilesDeserializer gkQuantilesDeserializer = new GKQuantilesDeserializer();

    @Override
    public Serializer<GKQuantilesSynopsis> serializer() {
        return (topic, data) -> {
    ...
    @Override
    public Deserializer<GKQuantilesSynopsis> deserializer() {
        return (topic, data) -> {
            try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
                ...
                GKQuantiles gkQuantiles = gkQuantilesDeserializer.deserialize(uncompressedData);

                // Construct the LossyCountingSynopsis object
                GKQuantilesSynopsis gkQuantilesSynopsis = new GKQuantilesSynopsis(synopsisInfo);
                gkQuantilesSynopsis.gkq = gkQuantiles;

                return gkQuantilesSynopsis;
